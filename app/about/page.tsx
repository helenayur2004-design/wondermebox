  ...
  return (
    <main>
      <PageHero
        ...
        text="wonder me box собирает готовые боксы, которые помогают поздравить тепло, аккуратно и без долгих поисков по разным магазинам."
        image="/products/classic-women-3.webp"
